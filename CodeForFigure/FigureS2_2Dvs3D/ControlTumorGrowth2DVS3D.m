...
%       parallelg=0;   
    ...
    % get T_stack1
    [T_stack1,o2_stack1,cell_num1,o2_lev1] = Hypoxia_model_v11(field_size,fracD,numD,delT,RTres,O2_th,leaking_factor,extradays0,0,0,n_cell_layers,parallelg,waitfor);
...
%       parallelg=0;   
    ...
    % Tstack not used here for parfor: use a classical for loop to
    % get T_stack1
    [T_stack1,o2_stack1,cell_num1,o2_lev1] = Hypoxia_model_3Dsphere(field_size,fracD,numD,delT,RTres,O2_th,leaking_factor,extradays0,0,0,n_cell_layers,parallelg,waitfor);
...
sim_count = sim_count + 1;
save(['Results\cell_num_Control3D_ncl_',num2str(n_cell_layers),'D_',num2str(fracD),'_nbdose',num2str(numD),'_delT',num2str(delT),'.mat'],'cell_num1','cell_num1_std','tc1');
