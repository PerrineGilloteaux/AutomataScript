...
for fracD = [   2 ]
    ...
    for i_sample = 1:num_sample; % number of repeat for average
        ...
        % get T_stack1
        %[T_stack1,o2_stack1,cell_num1,o2_lev1] = Hypoxia_model(field_size,fracD,numD,delT,RTres,O2_th,leaking_factor,extra_days,1,1,n_cell_layer,parallel,0);
