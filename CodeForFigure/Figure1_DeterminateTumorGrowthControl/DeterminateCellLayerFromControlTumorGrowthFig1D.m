...
volcell^(1/3)
shadedErrorBar(1:length(cell_num1),volcell*sum(cell_num1(:,[1,2,5]),2).*sqrt(sum(cell_num1(:,[1,2,5]),2)), sum(cell_num1_std(:,[1,2,5]),2).*sqrt(sum(cell_num1(:,[1,2,5]),2))*volcell);hold on;
end
