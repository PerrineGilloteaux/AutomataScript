function [soldosetotal ] = plotfigure6Asigmoid( fracD,delT,survival )
...
syms dosetotal
for numD = listenumD
    load(['Results\cell_num_Dose_f600_cl2_m4_',num2str(fracD),'nbdose',num2str(numD),'delT',num2str(delT),'test2.mat']);
