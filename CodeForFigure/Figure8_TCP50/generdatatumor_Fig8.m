...
for fracD = [ 2 3 4 6  ]
    ...
    for numD = unique([ 1 round(8/fracD) round(12/fracD) round(16/fracD) round(18/fracD) round(20/fracD) round(linspace(21/fracD,80/fracD,30))]) % number of fractions (DOSE TOTAL=70?)
        ...
        save(['Results\cell_num_Dose_f600_m1_',num2str(fracD),'nbdose',num2str(numD),'delT',num2str(delT),'.mat'],'cell_num1','cell_num1_std','tc1');
        save(['Results\cell_num_Dose_f600_m2_',num2str(fracD),'nbdose',num2str(numD),'delT',num2str(delT),'.mat'],'cell_num2','cell_num2_std','tc2');
        save(['Results\cell_num_Dose_f600_m3_',num2str(fracD),'nbdose',num2str(numD),'delT',num2str(delT),'.mat'],'cell_num3','cell_num3_std','tc3');
        save(['Results\cell_num_Dose_f600_m4_',num2str(fracD),'nbdose',num2str(numD),'delT',num2str(delT),'.mat'],'cell_num4','cell_num4_std','tc4');
